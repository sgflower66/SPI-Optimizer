#cifar10
python train_nag.py  -a alexnet  --dataset cifar10 --drop 0.3 --epochs 50 --schedule 30  --wd 1e-4 --gamma 0.1 --checkpoint checkpoint/test  --opt_method sgd  --train-batch 128 --lr 0.05 --momentum 0.9 --manualSeed 7000 --gpu_id 0
