#cifar10
python train_moment.py  -a wrn --depth 16 --widen-factor 8 --dataset cifar10 --drop 0.3 --epochs 200 --schedule 60 120 160 --wd 5e-4 --gamma 0.2 --checkpoint checkpoint/test --opt_method sgd  --train-batch 128 --lr 0.18 --manualSeed 20180817 --gpu_id 0
