...
KD=0
KDD=0
#logger = Logger('m_sp_.txos.path.join('1.5w_false_bp_6wcanshut', title='mnist')
logger = Logger(os.path.join('msp99_netj3_'+str(learning_rate)+'_'+str(seed)+'_KD:'+str(KD)+'_KDD:'+str(KDD)+'.txt'), title='mnist')
...
optimizer = SGD(net.parameters(), lr=learning_rate, weight_decay=0.0001, momentum=0.9,nesterov=False,KD=KD,KDD=KDD)
# Train the Model
