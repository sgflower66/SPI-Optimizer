...
logger = Logger(os.path.join('gds_netj3_'+str(learning_rate)+'_'+str(seed)+'.txt'), title='mnist')
...
optimizer = SGD(net.parameters(), lr=learning_rate, weight_decay=0.0001, momentum=0.9,nesterov=False)
# Train the Model
