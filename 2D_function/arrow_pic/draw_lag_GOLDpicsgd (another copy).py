...
#plt.plot([0,21], [0.65,0.65], linestyle='--',linewidth=1,color="black")
...
#plt.axvline(83,ls="--",linewidth=1,color="black")
...
font1 = {'size': 20}
font2 = {'size': 15}
legend1=ax2.legend(['SGD'],loc=1,prop = font1)
...
ax2.legend([l,grad],['MOM','gradient'],loc=4,prop = font2)
