...
def g(x0 , index = FN_INDEX):
    ...
    grad_list = [
                 ...
                 np.array([2*x - 2*x*(- 100*x**2 + 100*y) - 200*x*(- x**2 + y) - 2, - 200*x**2 + 200*y]),#rob

                np.array([((6*x + 6*y - 14)*(x + y + 1)**2 + (2*x + 2*y + 2)*(3*x**2 + 6*x*y - 14*x + 3*y**2 - 14*y + 19))*((2*x - 3*y)**2*(12*x**2 - 36*x*y - 32*x + 27*y**2 + 48*y + 18) + 30) + ((x + y + 1)**2*(3*x**2 + 6*x*y - 14*x + 3*y**2 - 14*y + 19) + 1)*((8*x - 12*y)*(12*x**2 - 36*x*y - 32*x + 27*y**2 + 48*y + 18) - (2*x - 3*y)**2*(36*y - 24*x + 32)),((6*x + 6*y - 14)*(x + y + 1)**2 + (2*x + 2*y + 2)*(3*x**2 + 6*x*y - 14*x + 3*y**2 - 14*y + 19))*((2*x - 3*y)**2*(12*x**2 - 36*x*y - 32*x + 27*y**2 + 48*y + 18) + 30) - ((x + y + 1)**2*(3*x**2 + 6*x*y - 14*x + 3*y**2 - 14*y + 19) + 1)*((12*x - 18*y)*(12*x**2 - 36*x*y - 32*x + 27*y**2 + 48*y + 18) - (2*x - 3*y)**2*(54*y - 36*x + 48))]),
...
ax2.set_yticks([-2,-1.5,-1,-0.5,0,0.14,1,1.5,2])
ax2.set_yticklabels([-2,-1.5,-1,-0.5,0,r"$\Delta\theta$",1,1.5,2])

plt.xlim(0,epoch )
plt.ylim(-2.1,1.8 )

plt.axvline(25,ls="--",linewidth=1,color="black")
plt.axvline(14,ls="--",linewidth=1,color="black")
plt.axvline(13,ls="--",linewidth=1,color="black")
plt.axhline(0,ls="--",linewidth=1,color="black")
plt.axhline(0.14,ls="--",linewidth=1,color="black")

ax2.set_xticks([0,13,15,20,40,60,80,25,100])
ax2.set_xticklabels([0,r"$t_1$",r"$t_2$",20,40,60,80, r"$t_s$",100])



font1 = {'size': 20}
font2 = {'size': 15}
legend1=ax2.legend(['SPI-Optimizer'],loc=1,prop = font1)
...
ax2.legend([l,grad,pregrad],['MOM','gradient','history gradient'],loc=4,prop = font2)
plt.gca().add_artist(legend1)
plt.savefig('f'+str(FN_INDEX)+'overm99.png', dpi=150, quality=100)
