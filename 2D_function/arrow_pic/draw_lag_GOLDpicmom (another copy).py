...
ax2.set_yticks([0,])
# plt.plot([0,23], [0.68,0.68], linestyle='--',linewidth=1,color="black")
...
# plt.axvline(93,ls="--",linewidth=1,color="black")
plt.axhline(0,ls="--",linewidth=1,color="black")


'''
ax2.set_xticks([0,13,21,40,60,80,93,100])
ax2.set_xticklabels([0,r"$t_1$",r"$t_2$",40,60,80, r"$t_s$",100])
'''
