...
#plt.plot(xx, yy, linestyle='--',linewidth=1,color="black")
# plt.plot([21,21], [-5,5], linestyle='--',linewidth=1,color="black")
# plt.plot([13,13], [-5,5], linestyle='--',linewidth=1,color="black")
ax2.set_yticks([-4,-1.8,0,2,4])
# plt.plot([0,22], [0.5,0.5], linestyle='--',linewidth=1,color="black")
ax2.set_yticklabels([-4,r"$\Delta\theta$",0,2,4])
#plt.plot([21,21], [-5,1], linestyle='-',linewidth=1,color="black")
...
plt.axvline(8,ls="--",linewidth=1,color="black")
plt.axhline(0,ls="--",linewidth=1,color="black")
plt.axhline(-1.8,ls="--",linewidth=1,color="black")

ax2.set_xticks([0,4,8,20,40,60,80,100])
ax2.set_xticklabels([0,r"$t_1$",r"$t_2$",20,40,60,80,100])#r"$t_s$"


font1 = {'size': 20}
font2 = {'size': 15}
legend1=ax2.legend(['MOM'],loc=1,prop = font1)
...
plt.savefig('f'+str(FN_INDEX)+'overmom.png', dpi=150, quality=100)