...
plt.axvline(22,ls="--",linewidth=1,color="black")
plt.axvline(14,ls="--",linewidth=1,color="black")
plt.axvline(55,ls="--",linewidth=1,color="black")
plt.axhline(0,ls="--",linewidth=1,color="black")
plt.axhline(0.5,ls="--",linewidth=1,color="black")

ax2.set_xticks([0,22,14,55,40,60,80,100])
