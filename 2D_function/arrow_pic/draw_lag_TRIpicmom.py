...
plt.axvline(32,ls="--",linewidth=1,color="black")
plt.axvline(84,ls="--",linewidth=1,color="black")
plt.axhline(0,ls="--",linewidth=1,color="black")
plt.axhline(0.5,ls="--",linewidth=1,color="black")

ax2.set_xticks([0,23,32,40,60,80,84,100])
ax2.set_xticklabels([0,r"$t_1$",r"$t_2$",40,60,80,r"$t_s$",100])#r"$t_s$"
