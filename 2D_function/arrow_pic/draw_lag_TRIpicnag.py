...
ax2.set_yticks([-2,0.4,0,2])
# plt.plot([0,22], [0.5,0.5], linestyle='--',linewidth=1,color="black")
ax2.set_yticklabels([-2,r"$\Delta\theta$",0,2])
#plt.plot([21,21], [-5,1], linestyle='-',linewidth=1,color="black")
...
plt.axvline(23,ls="--",linewidth=1,color="black")
plt.axvline(31,ls="--",linewidth=1,color="black")
plt.axvline(43,ls="--",linewidth=1,color="black")
plt.axhline(0,ls="--",linewidth=1,color="black")
plt.axhline(0.4,ls="--",linewidth=1,color="black")

ax2.set_xticks([0,23,31,43,40,60,80,100])
ax2.set_xticklabels([0,r"$t_1$",r"$t_2$",r"$t_s$",40,60,80,100])#r"$t_s$"
