...
ax2.set_yticks([-4,-2,-1.2,0,2,4])
# plt.plot([0,22], [0.5,0.5], linestyle='--',linewidth=1,color="black")
ax2.set_yticklabels([-4,-2,r"$\Delta\theta$",0,2,4])
#plt.plot([21,21], [-5,1], linestyle='-',linewidth=1,color="black")
...
plt.axvline(4,ls="--",linewidth=1,color="black")
plt.axvline(9,ls="--",linewidth=1,color="black")
plt.axhline(0,ls="--",linewidth=1,color="black")
plt.axhline(-1.2,ls="--",linewidth=1,color="black")

ax2.set_xticks([0,4,9,20,40,60,80,100])
