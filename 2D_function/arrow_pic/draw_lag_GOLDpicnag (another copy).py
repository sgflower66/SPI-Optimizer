...
i=-1
loss4=[]
#xa,x_arr0,loss0,grad_dot,pre_grad_dot,pre_grad2_dot, passing0 = momentum(start_point, step, g, discount)#momentum
#xa,x_arr0,loss0,grad_dot,pre_grad_dot,pre_grad2_dot, passing0  = sgd(start_point, step, g)#sgd
xa,x_arr0,loss0,grad_dot,pre_grad_dot,pre_grad2_dot, passing0  = nesterov(start_point, step, g, discount)#NAG
#xa,x_arr0,loss0,grad_dot,pre_grad_dot,pre_grad2_dot, passing0  = m99(start_point, step, g, discount)#
...
#plt.ylim(-0.1,0.25 )
#plt.axvline(93,ls="--",linewidth=1,color="darkviolet")
#plt.setp(ax1.get_xticklabels(), fontsize=6)

# plt.title('')

ax2= plt.subplot()
line=plt.plot(np.array((range(len(x0)))),x0,"-",color='darkblue',label='MOM_xt-1')
plt.plot(xx, yy, linestyle='--',linewidth=1,color="black")
# plt.plot([22,22], [-5,5], linestyle='--',linewidth=1,color="black")
# plt.plot([14,14], [-5,5], linestyle='--',linewidth=1,color="black")
ax2.set_yticks([-6,-4,-2,0,2,4.3,6])
# plt.plot([0,22], [0.5,0.5], linestyle='--',linewidth=1,color="black")
ax2.set_yticklabels([-6,-4,-2,0,2,r"$\Delta\theta$",6])
#plt.plot([21,21], [-5,1], linestyle='-',linewidth=1,color="black")
#plt.setp(ax1.get_xticklabels(), visible=False)
# plt.ylim(-2.1,1.8 )
plt.xlim(0,epoch )
#plt.annotate(r"$t$",xy=(13+0.2,-2.1),color="r",size=15)
#plt.annotate(r"$t$",xy=(34+0.2,-2.1),color="r",size=15)
plt.axvline(5,ls="--",linewidth=1,color="black")
plt.axvline(10,ls="--",linewidth=1,color="black")
plt.axhline(0,ls="--",linewidth=1,color="black")
plt.axhline(4.3,ls="--",linewidth=1,color="black")

ax2.set_xticks([0,5,10,20,40,60,80,100])
ax2.set_xticklabels([0,r"$t_1$",r"$t_2$",20,40,60,80,100])#r"$t_s$"

#legend1=ax2.legend(['MOM'],loc=1)
#legend1=ax2.legend(['SGD'],loc=1)
font1 = {'size': 20}
font2 = {'size': 15}
legend1=ax2.legend(['NAG'],loc=1,prop = font1)
...
#plt.annotate(r"$\delta$",xy=(delta+0.2,-3),color="r",size=15)
'''
#ax2.axis["left"].label.set_text("Long Label Left")
...
ax2.legend([grad,pregrad],['gradient','history gradient'],loc=4,prop=font2)
#bbox_to_anchor=(0.84, 0.9)
plt.gca().add_artist(legend1)
plt.savefig('f'+str(FN_INDEX)+'overnag.png', dpi=150, quality=100)