...
#plt.plot(xx, yy, linestyle='--',linewidth=1,color="black")
ax2.set_yticks([-2,-1,0.13,0,1,2])
# plt.plot([0,22], [0.5,0.5], linestyle='--',linewidth=1,color="black")
ax2.set_yticklabels([-2,-1,r"$\Delta\theta$",0,1,2])
#plt.plot([21,21], [-5,1], linestyle='-',linewidth=1,color="black")
...
plt.axvline(24,ls="--",linewidth=1,color="black")
plt.axvline(33,ls="--",linewidth=1,color="black")
plt.axhline(0,ls="--",linewidth=1,color="black")
plt.axhline(0.1,ls="--",linewidth=1,color="black")

ax2.set_xticks([0,22,24,33,40,60,80,100])
